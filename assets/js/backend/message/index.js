  ...
  initChat() {
    ...
    _this.addBtn.click(() => {
      ...
      if (txtMessage == "") {
        ...
        io.socket.post('/api/v1/backend/message/storeMessageData', {userId: userId, messageId: messageId, txtMessage: txtMessage, _csrf: window.SAILS_LOCALS._csrf }, function gotResponse(body, response) {
          console.log('Data: ', body);
        })
        $('#txtMessage').val('');
      }
