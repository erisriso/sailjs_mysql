...
const fn = {
  fetchData: async options => {
    return await Class.find(options).populate('courseSession').populate('students');//.populate('tuition');
  },
  fetchDataInOne: async options => {
    return await Class.findOne(options).populate('teachers').populate('students');//.populate('tuition');
  }
};
